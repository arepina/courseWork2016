from parsing.YandexMarketParser import YandexMarketParser
...
#                             item['link'], item['id'])
#         subcategoriesList = market.subcategory(category.id)[
#             'categories']  # all 'computer technique' subcategories (10 items)
...
#                 computerCategoriesList = market.subcategory(subcategory.id)['categories']  # all 'computer' subcategories (6 items)
